...
const SummarizeButton = ({ pendingText, children }: { pendingText: string, children: ReactNode }) => {
    ...
    return (
        <button
            ...
            aria-busy={pending}
            disabled={pending}
            className="group relative inline-flex items-center justify-center px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg hover:border-cyan-400/50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
        >
            ...
            <div className="relative flex items-center">
                ...
                <span className="font-medium bg-linear-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent">
